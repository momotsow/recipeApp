...
module.exports = function () {
	...
	_helpers.cloudinaryUrl = function (context, options) {
		...
		if ((context) && (context.publicid)) {
			options.hash.secure = keystone.get('cloudinary secure') || false;
			var imageName = context.publicid.concat('.', context.format);
	...
	// Direct url link to a specific recipe
	_helpers.recipeUrl = function (recipeSlug, options) {
